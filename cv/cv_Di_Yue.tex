...
\address{Email: diyue@cs.toronto.edu \\ Tel: (+86)18380578521} % Email
...
Discrepancy Theory, Approximation Algorithm, High-dimensional Computational Geometry, Metric Embeddings.
\end{rSection}
...
\begin{rSection}{Publications}{(In theoretical computer science, authors are listed in alphabetical order.)}
    ...
    %     {\bf Submitted}
    % \end{center}
    \begin{pubSubsection}{A Fast and Simple $(1 + \epsilon)$-Approximation for Minimum
    Spanning Trees in Doubling Metrics}
        \item Jan H\"ockendorff, Felix Hommelsheim, Christian Sohler, \textbf{Di Yue}.
        \item Manuscript, July 2026.
    \end{pubSubsection}

    \begin{pubSubsection}{Near Linear Time Approximation Schemes for
    Clustering of Partially Doubling Metrics}
        \item Anne Driemel, Jan H\"ockendorff, Ioannis Psarros, Christian Sohler, \textbf{Di Yue}.
        \item In Proceedings of ICALP 2026.
    \end{pubSubsection}
    ...
    \begin{pubSubsection}{Dimension Reduction for Clustering: The Curious Case of Discrete Centers}
        ...
        \item In Proceedings of ITCS 2026.
    \end{pubSubsection}
    ...
    \begin{pubSubsection}{Near-Optimal Dimension Reduction for Facility Location}
        ...
        \item In Proceedings of STOC 2025.
        % \href{https://arxiv.org/abs/2411.05432}{\texttt{arXiv:2411.05432}}.
    \end{pubSubsection}
\end{rSection}

\begin{rSection}{Service}{}
    Reviewer: SODA 2027, STOC 2026.
\end{rSection}

\begin{rSection}{Experiences}{}
    \begin{rSubsection}{Visiting Student, Nanjing University}{December 2025 - January 2026}{Advisor: Lingxiao Huang}{Nanjing, China}
        
    \end{rSubsection}

    \begin{rSubsection}{Visiting Student, University of Cologne}{September 2025 - December 2025}{Advisor: Christian Sohler}{Cologne, Germany}
        
    \end{rSubsection}


    \begin{rSubsection}{Visiting Student, Weizmann Institute of Science}{August 2024 - September 2024}{Advisor: Robert Krauthgamer}{Rehovot, Israel}
    ...
    \begin{rSubsection}{Research Assistant, Peking University}{July 2023 - September 2025}{Advisor: Shaofeng Jiang}{Beijing, China}

...
\begin{rSection}{Publications}{(In theoretical computer science, authors are listed in alphabetical order.)}
    ...
    Clustering of Partially Doubling Metrics}
        \item Anne Driemel, Jan Höckendorff, Ioannis Psarros, Christian Sohler, \textbf{Di Yue}.
        \item Manuscript, March 2026.
    \end{pubSubsection}
    ...
    \begin{pubSubsection}{Dimension Reduction for Clustering: The Curious Case of Discrete Centers}
        ...
        \item In Proceedings of \emph{The 17th Innovations in Theoretical Computer Science (ITCS 2026)}.
    \end{pubSubsection}
